...
namespace LaborRisk.LegalEngine
{
    public class ContractParserAgent
    {
        ...
        {
            string activeKey = "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";
  ...
  ""clauses"": [
    {
      ...
      ""strategy"": {
        ...
        ""talkingPoints"": ""Lời khuyên ngắn gọn để nói chuyện trực tiếp với HR/Sếp""
                ...
                request.Headers.Add("Authorization", $"Bearer {"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"}");
